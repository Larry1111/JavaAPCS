...
public class MyMath
{
  ...
  public static void mersennePrime() {
	    ...
	    for (int i = 2; counter < 6; i++) {
	        ...
	        long perf = (long)Math.pow(2, i-1)*val;
	        if (isPrime(val)) {
	            System.out.printf("%d (%d)%n",val, perf);
	            counter++;
	        }
	    }
  }
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("First four perfect number: ");
    perfNum();
    System.out.println("First 6 Mersenne primes along with their corresponding perfect numbers: ");
    mersennePrime();
  }
}
