  ...
  { //To avoid flicker
    ...
    public void init()
     {	int width, hei;
          ...
          data[5]=-0.5;
          data[6]=0.5;
          canv.setSize(600,300); //plot scrollbars panel and canvas
          ...
          pan1=new Panel();
          pan2=new Panel();
          pan.add(lm=new Label("Mass"));
          pan.add(mass=new TextField("0.2"));
          pan.add(lvx=new Label("Vx"));
          pan.add(vel=new TextField("0.2"));
          pan.add(lvy=new Label("Vy"));
          pan.add(vely=new TextField("0.0"));
          pan.add(lbi=new Label("b initial"));
          ...
          pan2.add(repul=new Checkbox("Repulsive",poten,true));
          pan2.add(atrac=new Checkbox("Attractive",poten,false));
          canv.setcon(-1);
          add("West",pan1);
          add("North", pan);
          add("South",pan2);
