...
public class Home extends JFrame implements ActionListener{
	...
	public void paint(Graphics g)
	{
		...
		g.drawLine(500, 300, 150, 200);
		g.drawLine(1000, 300, 1300, 200);
		g.setColor(Color.red);
		g.fillArc(GamePanel.W/2+130, 3*GamePanel.H/5-200, GamePanel.W/4, GamePanel.W/4, 30, 180);
		g.setColor(Color.blue);
		g.fillArc(GamePanel.W/4-130, 3*GamePanel.H/5-200, GamePanel.W/4, GamePanel.W/4, 150, -180);
